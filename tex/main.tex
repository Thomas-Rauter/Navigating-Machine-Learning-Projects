...
\begin{table}[H]
    \centering
    \small
    \caption{Supervised learning models that treat features independently (no interaction modeling). Data type support (structured or unstructured) and training speed are indicated.}
    \resizebox{\textwidth}{!}{%
    \begin{tabular}{|p{2.2cm}|c|c|p{2.5cm}|p{3cm}|p{3cm}|p{1.8cm}|}
        \hline
        \textbf{Model Type} & \textbf{Struct.} & \textbf{Unstruct.} & \textbf{When to Use} & \textbf{Advantages} & \textbf{Disadvantages} & \textbf{Training Speed} \\
        \hline
        Linear Regression & \cmark & \xmark & Structured data with linear relationships & Fast, interpretable, low variance & Assumes linearity, no interaction modeling unless manually added & \textbf{Very Fast} \\
        \hline
        ...
        \hline
        Naïve Bayes & \cmark & \xmark & Text classification or independent features & Extremely fast, works well on sparse data & Strong independence assumption, poor for correlated features & \textbf{Very Fast} \\
        \hline
    \end{tabular}
    }
\end{table}
...
\begin{table}[H]
    \centering
    \small
    \caption{Supervised learning models that model interactions between features. Data type support (structured or unstructured) and training speed are indicated.}
    \resizebox{\textwidth}{!}{%
    \begin{tabular}{|p{2.2cm}|c|c|p{2.5cm}|p{3cm}|p{3cm}|p{1.8cm}|}
        \hline
        \textbf{Model Type} & \textbf{Struct.} & \textbf{Unstruct.} & \textbf{When to Use} & \textbf{Advantages} & \textbf{Disadvantages} & \textbf{Training Speed} \\
        ...
        \hline
        NGBoost & \cmark & \xmark & When uncertainty estimates are needed & Predictive distributions, interpretable outputs & Slower training, less known & \textbf{Slow} \\
        \hline
